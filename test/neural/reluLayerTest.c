...
void testInitReluLayer() {
    ...
    assert(reluLayer->back->size->H == 1);
    assert(reluLayer->back->size->W == 2);
    assert(reluLayer->back->size->D == 3);
    assert(reluLayer->out != NULL);
    assert(reluLayer->out->size->H == 1);
    assert(reluLayer->out->size->W == 2);
    assert(reluLayer->out->size->D == 3);
