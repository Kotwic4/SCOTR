...
void TEST_initTensor() {
    ...
    assert(tensor1->size->height == p1.height);
    assert(tensor1->size->depth == p1.depth);
    assert(tensor1->size->width == p1.width);
...
void TEST_copyTensor() {
    ...
    assert(tensor1 != NULL);
    assert(tensor1->size->height == tensor2->size->height);
    assert(tensor1->size->depth == tensor2->size->depth);
    assert(tensor1->size->width == tensor2->size->width);
