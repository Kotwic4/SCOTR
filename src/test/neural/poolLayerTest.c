...
void testInitPoolLayer() {
    ...
    assert(poolLayer->back->size->height == 9);
    assert(poolLayer->back->size->width == 3);
    assert(poolLayer->back->size->depth == 3);
    assert(poolLayer->out != NULL);
    assert(poolLayer->out->size->height == 3);
    assert(poolLayer->out->size->width == 1);
    assert(poolLayer->out->size->depth == 3);
